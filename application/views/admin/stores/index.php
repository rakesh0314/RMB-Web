      ...
      <form role="form" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Prodect</label>
          ...
          <div class="form-group">
            <label for="brand_name">Prodect Unit</label>
            <select class="form-control" name="unit" id="unit">
            </select>
          </div>

          <div class="form-group">
            <label for="brand_name">Prodect Qnt</label>
            <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Enter Quantity" autocomplete="off">
          </div>
          <div class="form-group">
            <label for="brand_name">Purchase Price</label>
            <input type="number" class="form-control" id="proPrice" name="proPrice" placeholder="Enter Price" autocomplete="off">
          </div>
...
{
  var id = $('#store_name').val();
  $.ajax({
    url:"<?= base_url()?>stores/getProductunits",
    type:"GET",
    data:"pid="+id,
    dataType:'json',
    success:function(response)
