          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">Delivary-Charge <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
    ...
    if(product_id == "") {
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          $("#rate_"+row_id).val(response.sellprice);
          $("#rate_value_"+row_id).val(response.sellprice);
