                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      <tr>
                        <td>Admin</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createAdmin" class="minimal" <?php 
                        if($serialize_permission) {
                          if(in_array('createAdmin', $serialize_permission)) { echo "checked"; } 
                        }
                        ?> ></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateAdmin" <?php 
                        if($serialize_permission) {
                          if(in_array('updateAdmin', $serialize_permission)) { echo "checked"; } 
                        }
                        ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewAdmin" <?php 
                        if($serialize_permission) {
                          if(in_array('viewAdmin', $serialize_permission)) { echo "checked"; }   
                        }
                        ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteAdmin" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteAdmin', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Employee</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createEmp" <?php if($serialize_permission) {
                          if(in_array('createEmp', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateEmp" <?php if($serialize_permission) {
                          if(in_array('updateEmp', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewEmp" <?php if($serialize_permission) {
                          if(in_array('viewEmp', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteEmp" <?php if($serialize_permission) {
                          if(in_array('deleteEmp', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Category</td>
                      ...
                      <tr>
                        <td>About</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createAbout" class="minimal" <?php if($serialize_permission) {
                          if(in_array('createAbout', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateAbout" class="minimal" <?php if($serialize_permission) {
                          if(in_array('updateAbout', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewAbout" class="minimal" <?php if($serialize_permission) {
                          if(in_array('viewAbout', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteAbout" class="minimal" <?php if($serialize_permission) {
                          if(in_array('deleteAbout', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Banner</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createBanner" class="minimal" <?php if($serialize_permission) {
                          if(in_array('createBanner', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateBanner" class="minimal" <?php if($serialize_permission) {
                          if(in_array('updateBanner', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewBanner" class="minimal" <?php if($serialize_permission) {
                          if(in_array('viewBanner', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteBanner" class="minimal" <?php if($serialize_permission) {
                          if(in_array('deleteBanner', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Terms & Cond.</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createTerms" class="minimal" <?php if($serialize_permission) {
                          if(in_array('createTerms', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateTerms" class="minimal" <?php if($serialize_permission) {
                          if(in_array('updateTerms', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewTerms" class="minimal" <?php if($serialize_permission) {
                          if(in_array('viewTerms', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteTerms" class="minimal" <?php if($serialize_permission) {
                          if(in_array('deleteTerms', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Reports</td>
                      ...
                      <tr> 
                        <td>Contact</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewContact" class="minimal" <?php if($serialize_permission) {
                          if(in_array('viewContact', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteContact" class="minimal" <?php if($serialize_permission) {
