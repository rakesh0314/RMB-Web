    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createUnit', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Units</button>
          <br /> <br />
        <?php endif; ?>
      ...
      <form role="form" action="<?php echo base_url('unit/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <!-- <div class="form-group">
            <label for="brand_name">Select Prodect</label>
            ...
            <!-- <input type="text" class="form-control" id="store_name" name="store_name" placeholder="Enter Product name" autocomplete="off"> -->
          <!-- </div> -->

          <div class="form-group">
            <label for="brand_name">Unit</label>
            <input type="text" class="form-control" id="units" name="units" placeholder="Enter Unit" autocomplete="off">
          </div>
          <div class="form-group">
